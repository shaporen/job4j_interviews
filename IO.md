...
• Более удобный API: NIO.2 предлагает более простой и интуитивный API, основанный на концепции "путей" (Path) и "файловых систем" (FileSystem), которые делают работу с файлами более логичной и удобной.
