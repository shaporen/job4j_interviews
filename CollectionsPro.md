...
В Java итератор - это объект, который позволяет вам последовательно перебирать элементы коллекции, такие как List, Set или Map, не зная о её внутренней реализации. 
