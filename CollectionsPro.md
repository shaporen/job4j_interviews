...
3. Например, если `loadFactor` равен 0.75, а текущий размер таблицы 10, переразмерение будет выполнено, когда в таблице будет 7.5 элементов (0.75  10). Поскольку число элементов должно быть целым, переразмерение будет выполнено, когда в таблице будет 8 элементов.
