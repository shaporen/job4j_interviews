...
1. Условие:  Оценивается как `true` или `false`.
   
2. Выражение1: Выполняется и возвращает результат, если условие `true`.
  
3. Выражение2: Выполняется и возвращает результат, если условие `false`.
