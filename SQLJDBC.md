...
**Первичный ключ (Primary Key) в базе данных** - это один или несколько столбцов в таблице, которые однозначно идентифицируют каждую строку в этой таблице.
...
**Внешний ключ (Foreign Key) в базе данных** - это столбец (или комбинация столбцов) в одной таблице, который ссылается на первичный ключ другой таблицы. 
