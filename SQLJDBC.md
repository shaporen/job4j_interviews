...
1) **DML (Data Manipulation Language)** - язык манипулирования данными. Используется для изменения данных в уже существующих таблицах.
...
2) **DQL (Data Query Language)** - это язык запросов к данным, используемый для извлечения информации из базы данных. Он является частью SQL (Structured Query Language - структурированный язык запросов) и позволяет получить данные из таблиц, а также выполнить некоторые операции, не изменяющие данные.
